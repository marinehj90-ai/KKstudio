...
export const templateGroups = [
  {
    ...
    templates: [
      ...
      { id: 'b2',  name: '최상단 띠배너 (MO)',         size: '1536×140',  device: 'MO',   preview: PV_RICH, previewImage: '/assets/templates/previews/top-strip-banner-mo.png' },
      { id: 'b3',  name: '메인 대배너',               size: '750×750',   device: '공통', preview: PV_STD, previewImage: '/assets/templates/previews/main-large-banner-750.jpg' },
      { id: 'b4',  name: 'PC 와이드 대배너',           size: '1440×480',  device: 'PC',   preview: PV_DEEP, previewImage: '/assets/templates/previews/pc-wide-main-banner-1440x480.png' },
      { id: 'b5',  name: '통컨 기본배너',             size: '750×750',   device: '공통', preview: PV_WARM, previewImage: '/assets/templates/previews/tongcon-basic-banner.jpg' },
      { id: 'b6',  name: '통컨 띠배너 A (MO)',         size: '750×140',   device: 'MO',   preview: PV_RICH, previewImage: '/assets/templates/previews/strip-banner-750x140.png' },
      { id: 'b7',  name: '통컨 띠배너 B (PC)',         size: '1520×130',  device: 'PC',   preview: PV_STD, previewImage: '/assets/templates/previews/strip-banner-1520x130.png' },
      { id: 'b11', name: '메인 팝업 프로모션',         size: '750×560',   device: '공통', preview: PV_WARM, previewImage: '/assets/templates/previews/main-popup-promotion-750x560.jpg' },
  ...
  },
  {
    ...
    templates: [
      ...
      { id: 'e5', name: '기획전 MD추천 모듈',           size: '1440×1048', device: 'PC',   preview: PV_DEEP, heightResizable: true, singleSelectOnly: true },
    ],
  },
  {
    id: 'event',
