          ...
          <div className="max-w-2xl mx-auto">
            ...
            {inputMode === 'upload' && (
              ...
              >
                ...
                {uploadedImage ? (
                  <div>
                    <div className="mx-auto mb-4 rounded-none overflow-hidden shadow-lg max-h-64 max-w-full inline-block">
              ...
              <div className="relative overflow-hidden">
                {isGenerating ? (
                  ...
                  >
                    ...
                    {uploadedImage?.url && (
                      <div className="absolute bottom-4 right-4 w-24 h-24 rounded-none overflow-hidden shadow-2xl ring-2 ring-white/30">
